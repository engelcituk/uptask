...
const ModalEliminarColaborador = () => {
    const { handleModalEliminarColaborador, modalEliminarColaborador, eliminarColaborador, colaborador } = useProyectos() //uso del hook para trabajar con ProyectosProvider
